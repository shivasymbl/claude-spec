...
Task(subagent_type="postgres-pro", description="Database analysis", ...)
Task(subagent_type="penetration-tester", description="Deep security", ...)
Task(subagent_type="compliance-auditor", description="Compliance check", ...)
Task(subagent_type="chaos-engineer", description="Resilience review", ...)
Task(subagent_type="accessibility-tester", description="A11y review", ...)  # If UI
